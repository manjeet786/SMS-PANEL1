...
<html> 
    ...
    <head>
        <meta charset="utf-8">
        <title>My Orders | Gallaxy Responsive HTML5/CSS3 Template | FIFO THEMES</title>
                        ...
                        <div class="container">
                            ...
                            <div class="phone-login pull-right">
                                ...
                                <div class="btn-group currency btn-select">
                                    ...
                                    <span class="hidden-xs"><img src="img/shop/currency.png" alt=""></span><span class="visible-xs"><img src="img/shop/currency.png" alt=""></span>
                                    <span class="caret"></span>
                                    </a>
                                    <ul class="dropdown-menu">
                                        <li><a href="#"><img alt="" src="img/shop/flags/USA.png"> USD</a></li>
                                        <li><a href="#"><img alt="" src="img/shop/flags/France.png"> EURO</a></li>
                                        <li><a href="#"><img alt="" src="img/shop/flags/Bangladesh.png"> BDT</a></li>
                                    </ul>
                                </div>
                                <!-- /Currency Selector -->
                                <!-- Language Selector -->
                                <div class="btn-group language btn-select">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="#"><img alt="" src="img/shop/flags/USA.png"> English</a></li>
                                        <li><a href="#"><img alt="" src="img/shop/flags/France.png"> France</a></li>
                                        <li><a href="#"><img alt="" src="img/shop/flags/Germany.png"> Germany</a></li>
                                    </ul>
                                </div>
                                <!-- /Language Selector -->
                                <a href="my-account.html"><i class="fa fa-user"></i> My Account</a>
                                <a href="#"><i class="fa fa-list-alt"></i> My Wishlist</a>
                                        ...
                                        <table class="table table-striped table-responsive table-bordered text-left my-orders-table">
                                            <thead>
                                                <tr class="first last">
                                                    ...
                                                    <th>Name</th>
                                                    <th>Phone</th>
                                                    <th><span class="nobr">Mail_Id</span></th>
                                                    <th>Credits</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center last">
                                                        <div class="btn-group">
                                                            <a href="#" class="btn btn-color">View Order</a>
                                                            <a href="#" class="btn btn-default">Reorder</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
